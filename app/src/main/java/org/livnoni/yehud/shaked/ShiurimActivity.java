...
public class ShiurimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.livnoni.yehud.shaked.R.layout.activity_shiurim);

        setTitle("שיעורים");


        dayName=new String []{getString(org.livnoni.yehud.shaked.R.string.Sunday),getString(org.livnoni.yehud.shaked.R.string.Monday),getString(org.livnoni.yehud.shaked.R.string.Tuesday), getString(org.livnoni.yehud.shaked.R.string.Wednesday), getString(org.livnoni.yehud.shaked.R.string.Thursday), getString(org.livnoni.yehud.shaked.R.string.Friday), getString(org.livnoni.yehud.shaked.R.string.Saturday)};
        ...
        dayNameTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.dayNameTV);
        textTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.textTV);
        dayForwardBtn = (Button) findViewById(org.livnoni.yehud.shaked.R.id.dayForwardBtn);
        dayBackBtn = (Button) findViewById(org.livnoni.yehud.shaked.R.id.dayBackBtn);


        radioButtons = new RadioButton[7];
        LinearLayoutForBtns = (LinearLayout) findViewById(org.livnoni.yehud.shaked.R.id.LinearLayoutForBtns);
        ...
        LinearLayout layout = (LinearLayout)findViewById(org.livnoni.yehud.shaked.R.id.shuirLinearLayoutTV);
...
//        });
    ...
    public void initializelUI()
    {
        ...
        if(numOfShuirs > 0)
        {
            ...
            {
                View child = getLayoutInflater().inflate(org.livnoni.yehud.shaked.R.layout.shuir_layout, null);
                childsVector.add(child);
                StaticClass.Shiur tempShuir = shuirs.getVectorOfShuirs(currentDay).get(i);

                TextView shuirNameTV = (TextView) child.findViewById(org.livnoni.yehud.shaked.R.id.shuirNameTV);
                shuirNameTV.setText(tempShuir.getName());
                TextView shuirTimeTV = (TextView) child.findViewById(org.livnoni.yehud.shaked.R.id.shuirTimeTV);
                shuirTimeTV.setText(tempShuir.getTime());
                TextView shuirGuidedByTV = (TextView) child.findViewById(org.livnoni.yehud.shaked.R.id.shuirGuidedByTV);
                shuirGuidedByTV.setText(tempShuir.getSpokenBy());
                TextView shuirLocationTV = (TextView) child.findViewById(org.livnoni.yehud.shaked.R.id.shuirLocationTV);
                shuirLocationTV.setText(tempShuir.getLocation());
                TextView shuirDetailsTV = (TextView) child.findViewById(org.livnoni.yehud.shaked.R.id.shuirDetailsTV);
