...
public class TfilaActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.livnoni.yehud.shaked.R.layout.activity_tfila);

        forceEnglishView();

        saturdayTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.saturdayTV);
    ...
    public void initializelUI()
    {
        if(numOfMinayans > 0 )
        {
            ...
            minyanTitleTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.minyanTitleTV);

            week_sharitTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.week_sharitTimesTV);
            week_MinhaTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.week_MinhaTimesTV);
            week_ArvitTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.week_ArvitTimesTV);
            saturday_kabalatShabatTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.saturday_kabalatShabatTimesTV);
            saturday_sharitTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.saturday_sharitTimesTV);
            saturday_MinhaTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.saturday_MinhaTimesTV);
            saturday_ArvitTimesTV = (TextView) findViewById(org.livnoni.yehud.shaked.R.id.saturday_ArvitTimesTV);
